  ...
  return (
    <div className='sm:flex min-h-screen'>
      ...
      <div className='relative sm:w-1/2 overflow-hidden'>
        ...
        {/* Tarjetas */}
        {/* <div className='relative py-20 sm:h-full flex flex-col justify-center items-start px-16 gap-6'> */}
        <div className="grid grid-cols-1 sm:grid-cols-2 relative">
          ...
          <div className="relative top-[15%] left-[26%] sm:top-[170%] sm:left-[55%]">
            ...
            <div className="absolute top-[44.5%] left-[52%] sm:top-[44%] sm:left-[79%] text-white sm:text-[0.95vw]">
              {watch("cvc") || "000"}
            </div>
          </div>

          {/* Imagen delantera */}
          <div className="relative top-[-28.5%] right-[-10%] sm:top-[50%] sm:right-[65%]">
            <img src={cardFront} className='w-[65%] sm:w-full'/>

            {/* Logo */}
            <div className='absolute top-[12%] left-[4%] sm:left-[6%] z-20'>
      ...
      {/* Formulario */}
      <div className='sm:w-1/2 flex items-center justify-center py-10'>

        {!isSubmitted ? (
        <form 
          className="w-full max-w-md sm:scale-110 scale-[90%]" 
